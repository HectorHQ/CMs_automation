...
st.set_page_config('Credit Memos Automation Service',
                    page_icon= ':file_folder:',
                    layout= 'wide'
                    )

st.title(':orange[Credit Memos] Automation Service :file_folder:')
...
if file_uploaded:
    ...
    if submit_applications:
        ...
        cm_webhook = 'https://hook.us1.make.com/49c1zbfc3qvgv5ve6n6cy75pnkug6pfy'
        ...
        cms_logs = 'https://docs.google.com/spreadsheets/d/1FIUgBjI8LA65_ha6XDR3_x7ubqUD_dIke8RPcUdRXUE/edit#gid=0'
